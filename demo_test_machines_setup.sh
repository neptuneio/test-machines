...
AGENT_USER="ubuntu" END_POINT="staging.neptune.io" API_KEY="03652462674c4d30ad183e3c8c048a82" bash -c "$(curl -sS -L https://raw.githubusercontent.com/neptuneio/neptune-agent/master/scripts/linux/install_neptune_agent_linux.sh)"
...
scoutd --key=5S3e2mIKqSi1NfSGJqQcjjt7bxoUfncYa3O9lF5L --environment=staging --roles=DemoApps config > /etc/scout/scoutd.yml
scoutctl restart
