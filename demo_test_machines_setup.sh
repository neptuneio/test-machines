...
AGENT_USER="ubuntu" END_POINT="neptune-staging-env.herokuapp.com" API_KEY="03652462674c4d30ad183e3c8c048a82" bash -c "$(curl -sS -L https://raw.githubusercontent.com/neptuneio/neptune-agent/master/scripts/linux/install_neptune_agent_linux.sh)"
